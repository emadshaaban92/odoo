    ...
    def _reevaluate_leaves(self, time_domain_dict):
        ...
        for previous_duration, leave, state in zip(previous_durations, leaves, previous_states):
            ...
            try:
                ...
                leave.action_draft()
                message = _("Due to a change in global time offs, this leave no longer has the required amount of available allocation and has been reset to the draft state. Please review this leave.")
            if message:
