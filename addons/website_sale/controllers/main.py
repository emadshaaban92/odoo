...
class WebsiteSale(http.Controller):
    ...
    def _get_express_shop_payment_values(self, order, **kwargs):
        vals = sale_portal.CustomerPortal._get_payment_values(
            self,
            order,
            tokens_included=None,
    ...
    def _get_shop_payment_values(self, order, **kwargs):
        portal_payment_values = sale_portal.CustomerPortal._get_payment_values(
            self, order, website_id=request.website.id
        )
        portal_payment_values.update({
            'website_sale_order': order,
            'errors': [],
