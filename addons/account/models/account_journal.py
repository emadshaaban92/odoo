...
class AccountJournal(models.Model):
    ...
    bank_acc_number = fields.Char(related='bank_account_id.acc_number', inverse=True)
    bank_id = fields.Many2one('res.bank', related='bank_account_id.bank_id', inverse=True)
