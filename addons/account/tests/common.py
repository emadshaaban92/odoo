...
class AccountTestInvoicingCommon(TransactionCase):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        if chart_template_ref:
            template_vals = cls.env['account.chart.template'].get_chart_template_mapping()[chart_template_ref]
            template_module = cls.env.ref(f"base.module_{template_vals['modules'][0]}")
