...
class Generate2307Wizard(models.TransientModel):
    ...
    def _write_rows(self, worksheet, moves):
        ...
        for move in moves:
            ...
            partner_address_info = [partner.street, partner.street2, partner.city, partner.state_id and partner.state_id.name, partner.country_id.name]
            values = {
                'invoice_date': move.invoice_date.strftime("%m/%d/%Y") if move.invoice_date else '',
