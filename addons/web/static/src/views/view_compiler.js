...
export class ViewCompiler {
    constructor(templates) {
        ...
        this.ctx = { readonly: "__abcde__.props.readonly" };
    ...
    applyInvisible(invisible, compiled, params) {
        ...
        const recordExpr = params.recordExpr || "__abcde__.props.record";
        let isVisileExpr = `!__abcde__.evalDomainFromRecord(${recordExpr},${JSON.stringify(invisible)})`;
    ...
    compileField(el, params) {
        ...
        field.setAttribute("record", params.recordExpr || "__abcde__.props.record");
        field.setAttribute("fieldInfo", `__abcde__.props.archInfo.fieldNodes['${fieldId}']`);
    ...
    compileWidget(el) {
        const attrs = {};
        const props = { record: "__abcde__.props.record", readonly: this.ctx.readonly };
        for (const { name, value } of el.attributes) {
            switch (name) {
                case "class":
                case "name": {
