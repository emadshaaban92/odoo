...
QUnit.module("SettingsFormView", (hooks) => {
    ...
    QUnit.test("standalone field labels with string inside a settings page", async (assert) => {
        ...
        const expectedCompiled = `
            <SettingsPage slots="{NoContentHelper:__abcde__.props.slots.NoContentHelper}" initialTab="__abcde__.props.initialApp" t-slot-scope="settings" modules="[{&quot;key&quot;:&quot;crm&quot;,&quot;string&quot;:&quot;CRM&quot;,&quot;imgurl&quot;:&quot;/crm/static/description/icon.png&quot;}]">
                <SettingsApp key="\`crm\`" string="\`CRM\`" imgurl="\`/crm/static/description/icon.png\`" selectedTab="settings.selectedTab">
                    <Setting title="\`\`"  help="\`\`" companyDependent="false" documentation="\`\`" record="__abcde__.props.record" string="\`\`" addLabel="true" labels="[&quot;\`My\\&quot; little '  Label\`&quot;]">
                        <FormLabel id="'display_name'" fieldName="'display_name'" record="__abcde__.props.record" fieldInfo="__abcde__.props.archInfo.fieldNodes['display_name']" className="&quot;highhopes&quot;" string="\`My&quot; little '  Label\`"/>
    ...
    QUnit.test("highlight Element with inner html/fields", async (assert) => {
        ...
        const expectedCompiled = `
            ...
            <Field id="'baz'" name="'baz'" record="__abcde__.props.record" fieldInfo="__abcde__.props.archInfo.fieldNodes['baz']"/>
