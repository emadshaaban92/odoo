...
QUnit.module("Form Compiler", (hooks) => {
    ...
    QUnit.test("properly compile simple div", async (assert) => {
        ...
        const expected = /*xml*/ `
            <t>
                <div t-att-class="__abcde__.props.class" t-attf-class="{{__abcde__.props.record.isInEdition ? 'o_form_editable' : 'o_form_readonly'}} d-block {{ __abcde__.props.record.isDirty ? 'o_form_dirty' : !__abcde__.props.record.isVirtual ? 'o_form_saved' : '' }}" class="o_form_nosheet" t-ref="compiled_view_root">
                    <div>lol</div>
                </div>
            </t>`;
    ...
    QUnit.test(
        ...
        async (assert) => {
            ...
            <t>
                <div t-att-class="__abcde__.props.class" t-attf-class="{{__abcde__.props.record.isInEdition ? 'o_form_editable' : 'o_form_readonly'}} d-block {{ __abcde__.props.record.isDirty ? 'o_form_dirty' : !__abcde__.props.record.isVirtual ? 'o_form_saved' : '' }}" class="o_form_nosheet" t-ref="compiled_view_root">
                    <Field id="'test'" name="'test'" record="__abcde__.props.record" fieldInfo="__abcde__.props.archInfo.fieldNodes['test']" />
                    <FormLabel id="'test'" fieldName="'test'" record="__abcde__.props.record" fieldInfo="__abcde__.props.archInfo.fieldNodes['test']" className="&quot;&quot;" string="\`\`" />
                </div>
            </t>`;
            assert.areEquivalent(compileTemplate(arch), expected);
        }
        ...
        const expected = /*xml*/ `
            <t>
                <div t-att-class="__abcde__.props.class" t-attf-class="{{__abcde__.props.record.isInEdition ? 'o_form_editable' : 'o_form_readonly'}} d-block {{ __abcde__.props.record.isDirty ? 'o_form_dirty' : !__abcde__.props.record.isVirtual ? 'o_form_saved' : '' }}" class="o_form_nosheet" t-ref="compiled_view_root">
                    <div class="someClass">
                        lol
                        <Field id="'display_name'" name="'display_name'" record="__abcde__.props.record" fieldInfo="__abcde__.props.archInfo.fieldNodes['display_name']"/>
                    </div>
                </div>
            </t>`;
            ...
            <OuterGroup>
               <t t-set-slot="item_0" type="'item'" sequence="0" t-slot-scope="scope" isVisible="true" itemSpan="1">
                  <InnerGroup class="scope &amp;&amp; scope.className">
                     <t t-set-slot="item_0" type="'item'" sequence="0" t-slot-scope="scope" props="{id:'display_name',fieldName:'display_name',record:__abcde__.props.record,string:__abcde__.props.record.fields.display_name.string,fieldInfo:__abcde__.props.archInfo.fieldNodes['display_name']}" Component="__abcde__.constructor.components.FormLabel" subType="'item_component'" isVisible="true" itemSpan="2">
                        <Field id="'display_name'" name="'display_name'" record="__abcde__.props.record" fieldInfo="__abcde__.props.archInfo.fieldNodes['display_name']" class="scope &amp;&amp; scope.className" />
                     </t>
                  </InnerGroup>
               </t>
               <t t-set-slot="item_1" type="'item'" sequence="1" t-slot-scope="scope" isVisible="true" itemSpan="1">
                  <InnerGroup class="scope &amp;&amp; scope.className">
                     <t t-set-slot="item_0" type="'item'" sequence="0" t-slot-scope="scope" props="{id:'charfield',fieldName:'charfield',record:__abcde__.props.record,string:__abcde__.props.record.fields.charfield.string,fieldInfo:__abcde__.props.archInfo.fieldNodes['charfield']}" Component="__abcde__.constructor.components.FormLabel" subType="'item_component'" isVisible="true" itemSpan="2">
                        <Field id="'charfield'" name="'charfield'" record="__abcde__.props.record" fieldInfo="__abcde__.props.archInfo.fieldNodes['charfield']" class="scope &amp;&amp; scope.className" />
                     </t>
                  </InnerGroup>
               </t>
            </OuterGroup>`;
                ...
                <div t-att-class="__abcde__.props.class" t-attf-class="{{__abcde__.props.record.isInEdition ? 'o_form_editable' : 'o_form_readonly'}} d-block {{ __abcde__.props.record.isDirty ? 'o_form_dirty' : !__abcde__.props.record.isVirtual ? 'o_form_saved' : '' }}" class="o_form_nosheet" t-ref="compiled_view_root">
                    <OuterGroup>
                        <t t-set-slot="item_0" type="'item'" sequence="0" t-slot-scope="scope" isVisible="true" itemSpan="1">
                            <InnerGroup class="scope &amp;&amp; scope.className">
                                <t t-set-slot="item_0" type="'item'" sequence="0" t-slot-scope="scope" isVisible="true" itemSpan="1">
                                    <div t-att-class="__abcde__.props.class" t-attf-class="{{__abcde__.props.record.isInEdition ? 'o_form_editable' : 'o_form_readonly'}} d-block {{ __abcde__.props.record.isDirty ? 'o_form_dirty' : !__abcde__.props.record.isVirtual ? 'o_form_saved' : '' }} {{scope &amp;&amp; scope.className || &quot;&quot; }}" class="o_form_nosheet">
                                        <div><Field id="'test'" name="'test'" record="__abcde__.props.record" fieldInfo="__abcde__.props.archInfo.fieldNodes['test']"/></div>
                                    </div>
                                </t>
                            </InnerGroup>
                        </t>
    ...
    QUnit.test("properly compile notebook", async (assert) => {
        ...
        const expected = /*xml*/ `
            <Notebook defaultPage="__abcde__.props.record.isNew ? undefined : __abcde__.props.activeNotebookPages[0]" onPageUpdate="(page) =&gt; __abcde__.props.onNotebookPageChange(0, page)">
                <t t-set-slot="page_1" title="\`Page1\`" name="\`p1\`" isVisible="true">
                    <Field id="'charfield'" name="'charfield'" record="__abcde__.props.record" fieldInfo="__abcde__.props.archInfo.fieldNodes['charfield']"/>
                </t>
    ...
    QUnit.test("properly compile sheet", async (assert) => {
        ...
        const expected = /*xml*/ `
            <t>
            <div t-att-class="__abcde__.props.class" t-attf-class="{{__abcde__.props.record.isInEdition ? 'o_form_editable' : 'o_form_readonly'}} d-flex {{ __abcde__.uiService.size &lt; 6 ? &quot;flex-column&quot; : &quot;flex-nowrap h-100&quot; }} {{ __abcde__.props.record.isDirty ? 'o_form_dirty' : !__abcde__.props.record.isVirtual ? 'o_form_saved' : '' }}" t-ref="compiled_view_root">
    ...
    QUnit.test("properly compile invisible", async (assert) => {
        ...
        const expected = /*xml*/ `
            <div class="visible3" />
            <div t-if="!__abcde__.evalDomainFromRecord(__abcde__.props.record,[[&quot;display_name&quot;,&quot;=&quot;,&quot;take&quot;]])" />
        `;
...
QUnit.module("Form Renderer", (hooks) => {
    ...
    QUnit.test("invisible is correctly computed with another t-if", (assert) => {
        ...
        const expected = `<t><div class="myNode" t-if="( myCondition or myOtherCondition ) and !__abcde__.evalDomainFromRecord(__abcde__.props.record,[[&quot;field&quot;,&quot;=&quot;,&quot;value&quot;]])" t-ref="compiled_view_root"/></t>`;
        assert.areEquivalent(compileTemplate(arch), expected);
    });
});
