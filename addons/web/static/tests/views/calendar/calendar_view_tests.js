...
QUnit.module("Views", ({ beforeEach }) => {
    ...
    QUnit.test(`allowed scales`, async (assert) => {
        ...
        assert.containsOnce(target, ".o_view_scale_button .o_scale_button_day");
        assert.containsOnce(target, ".o_view_scale_button .o_scale_button_week");
        assert.containsNone(target, ".o_view_scale_button .o_scale_button_month");
        assert.containsNone(target, ".o_view_scale_button .o_scale_button_year");
    });
