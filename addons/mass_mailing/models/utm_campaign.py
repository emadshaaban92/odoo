...
class UtmCampaign(models.Model):
    ...
    ab_testing_winner_mailing = fields.Many2one("mailing.mailing", "A/B Campaign Winner Mailing", copy=False)
    ...
    @api.depends('ab_testing_winner_mailing')
    def _compute_ab_testing_completed(self):
        for campaign in self:
            campaign.ab_testing_completed = bool(self.ab_testing_winner_mailing)
    ...
    def _cron_process_mass_mailing_ab_testing(self):
        ...
        ab_testing_campaign = self.search([
            ...
            ('ab_testing_winner_mailing', '=', False),
        ])
