...
class TestCRMPLS(TransactionCase):
    ...
    def test_predictive_lead_scoring(self):
        ...
        # NOTE: if we modify active, stage_id and probability, the cache needs to be invalidated in order to get the
