...
class Lead(models.Model):
    ...
    def search(self, domain, field_names=(), offset=0, limit=None, order=None):
        ...
        if not order or 'my_activity_date_deadline' not in order:
            return super(Lead, self).search(domain, field_names, offset, limit, order)
        ...
        search_res = super(Lead, self).search(my_lead_domain, field_names, offset=0, limit=None, order=my_lead_order)
        ...
        other_lead_res = super(Lead, self).search(
            ...
            field_names, offset=lead_offset, limit=lead_limit, order=lead_order,
        )
