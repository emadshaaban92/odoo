...
class Lead(models.Model):
    ...
    def search(self, domain, offset=0, limit=None, order=None):
        ...
        if not order or 'my_activity_date_deadline' not in order:
            return super(Lead, self).search(domain, offset=offset, limit=limit, order=order)
        ...
        search_res = super(Lead, self).search(my_lead_domain, offset=0, limit=None, order=my_lead_order)
        ...
        other_lead_res = super(Lead, self).search(
            ...
            offset=lead_offset, limit=lead_limit, order=lead_order,
        )
