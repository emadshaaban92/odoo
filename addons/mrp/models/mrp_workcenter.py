...
class MrpWorkcenter(models.Model):
    ...
    # resource
    name = fields.Char('Work Center', related='resource_id.name', store=True, inverse=True)
    time_efficiency = fields.Float('Time Efficiency', related='resource_id.time_efficiency', default=100, store=True, inverse=True)
...
class MrpWorkcenterProductivityLoss(models.Model):
    ...
    loss_type = fields.Selection(string='Effectiveness Category', related='loss_id.loss_type', store=True, inverse=True)
...
class MrpWorkcenterProductivity(models.Model):
    ...
    loss_type = fields.Selection(
        string="Effectiveness", related='loss_id.loss_type', store=True, inverse=True)
