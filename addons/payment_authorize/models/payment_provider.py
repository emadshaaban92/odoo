...
class PaymentProvider(models.Model):
    ...
    def _onchange_authorize_payment_method_type(self):
        if self.authorize_payment_method_type == 'bank_account':
            ...
            self.payment_method_ids = [Command.set([self.env.ref(payment_method_xml_id).id for payment_method_xml_id in (
                'payment.payment_method_cc_maestro',
                'payment.payment_method_cc_mastercard',
                'payment.payment_method_cc_discover',
                'payment.payment_method_cc_diners_club_intl',
                'payment.payment_method_cc_jcb',
                'payment.payment_method_cc_visa',
            )])]
