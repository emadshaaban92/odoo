...
class PaymentTransaction(models.Model):
    ...
    def _set_pending(self, state_message=None, extra_allowed_states=None):
        ...
        """
        txs_to_process = super()._set_pending(state_message=state_message, extra_allowed_states=extra_allowed_states)
    ...
    def _set_authorized(self, state_message=None, extra_allowed_states=None):
        ...
        super()._set_authorized(state_message=state_message, extra_allowed_states=extra_allowed_states)
