...
class PosOrder(models.Model):
    ...
    session_id = fields.Many2one(
        ...
        readonly=True)
    config_id = fields.Many2one('pos.config', related='session_id.config_id', string="Point of Sale", inverse=True)
    ...
    picking_type_id = fields.Many2one('stock.picking.type', related='session_id.config_id.picking_type_id', string="Operation Type", inverse=True)
...
class PosOrderLineLot(models.Model):
    ...
    order_id = fields.Many2one('pos.order', related="pos_order_line_id.order_id", inverse=True)
    lot_name = fields.Char('Lot Name')
    product_id = fields.Many2one('product.product', related='pos_order_line_id.product_id', inverse=True)
