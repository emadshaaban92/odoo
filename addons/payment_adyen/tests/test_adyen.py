...
class AdyenTest(AdyenCommon, PaymentHttpCommon):
    ...
    def test_send_full_capture_request_do_not_create_child_tx(self):
        self.provider.capture_manually = True
    ...
    def test_send_partial_capture_request_creates_child_tx(self):
        self.provider.capture_manually = True
        source_tx = self._create_transaction(flow='direct', state='authorized')
        with patch(
            'odoo.addons.payment_adyen.models.payment_provider.PaymentProvider._adyen_make_request',
    ...
    def test_send_full_void_request_do_not_create_child_tx(self):
        self.provider.capture_manually = True
        source_tx = self._create_transaction(flow='direct', state='authorized')
        with patch(
            'odoo.addons.payment_adyen.models.payment_provider.PaymentProvider._adyen_make_request',
    ...
    def test_send_partial_void_request_creates_child_tx(self):
        self.provider.capture_manually = True
        source_tx = self._create_transaction(flow='direct', state='authorized')
        with patch(
            'odoo.addons.payment_adyen.models.payment_provider.PaymentProvider._adyen_make_request',
