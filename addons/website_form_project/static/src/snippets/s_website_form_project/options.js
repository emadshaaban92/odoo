odoo.define('website_form_project.form_editor', function (require) {
    'use strict';
    
    const core = require('web.core');
    const FormEditorRegistry = require('website.form_editor_registry');
    const WebsiteFormEditor = require('website.form_editor');
                    ...
                    buttons: [
                        {
                            ...
                            click: (ev) => {
                                ...
                                this._redirectToAction(redirectAction);
                                reject();
                            },
                        }, {
                            text: _t("Cancel"),
