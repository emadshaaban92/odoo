...
const { corePluginRegistry, coreViewsPluginRegistry, statefulUIPluginRegistry } =
...
statefulUIPluginRegistry.add("OdooPivotUIPlugin", PivotUIPlugin);
statefulUIPluginRegistry.add("OdooListUIPlugin", ListUIPlugin);
