...
registry.category("fields").add("project_task_state_selection_m2o", ProjectTaskStateSelectionMany2One);

export function preloadState(orm, record, fieldName) {
    return orm.webSearchRead("project.task.state", [], ["name", "key", "approval_mode"]);
}

registry.category("preloadedData").add("project_task_state_selection_m2o", {
