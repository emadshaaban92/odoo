...
class ResConfigSettings(models.TransientModel):
    ...
    resource_calendar_id = fields.Many2one(
        ...
        related='company_id.resource_calendar_id', inverse=True)
    ...
    hr_presence_control_email_amount = fields.Integer(related="company_id.hr_presence_control_email_amount", inverse=True)
    hr_presence_control_ip_list = fields.Char(related="company_id.hr_presence_control_ip_list", inverse=True)
