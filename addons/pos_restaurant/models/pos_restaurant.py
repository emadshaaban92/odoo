...
class RestaurantFloor(models.Model):
    ...
    pos_config_ids = fields.Many2many('pos.config', 'restaurant_floor_pos_config_rel', 'restaurant_floor_id', 'pos_config_id', string='Point of Sales', domain="[('module_pos_restaurant', '=', True)]")
