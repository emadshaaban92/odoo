...
class ResourceCalendarLeaves(models.Model):
    ...
    def _timesheet_create_lines(self):
        ...
        vals_list = []
        def get_timesheets_data(employees, work_hours_list):
            calendar_list = []
        ...
        for leave in self:
            if not leave.calendar_id:
                for calendar_id, calendar_employees in mapped_employee.items():
                    ...
                    vals_list += get_timesheets_data(calendar_employees, work_hours_list)
            else:
                ...
                vals_list += get_timesheets_data(employees, work_hours_list)
