...
class UserInputSession(http.Controller):
    ...
    def survey_session_manage(self, survey_token, **kwargs):
        ...
        # Generate QR code
        session_qr_image = qrcode.make(survey.session_link, border=1)
        session_qr_image_bytes = io.BytesIO()
        session_qr_image.save(session_qr_image_bytes, format='JPEG')
        qrcode_base64 = base64.b64encode(session_qr_image_bytes.getvalue())
