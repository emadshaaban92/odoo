...
class Channel(models.Model):
    ...
    def execute_command_help(self, **kwargs):
        ...
        if self.channel_type == 'channel':
            ...
            channel_members = ', @'.join(channel_partners.mapped('partner_id.name') + channel_partners.mapped('guest_id.name'))
            msg = _("You are in a private conversation with <b>@%s</b>.", html_escape(channel_members if channel_members else _('Anonymous')))
