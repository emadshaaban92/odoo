    ...
    def create(self, values_list):
        ...
        for values in values_list:
            ...
            if 'body' in values:
                ...
                values['body'] = _image_dataurl.sub(base64_to_boundary, tools.html_sanitize(values['body'], sanitize_tags=False, strip_classes=True) if values.get('message_type') == 'email' else tools.ustr(values['body']))
