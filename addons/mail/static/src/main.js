...
console.log("Pre add thirdmanager to private registry");
registry.category('main_components').add('ThirdManagerContainer', { Component: ThirdManagerContainer });
console.log("Post add thirdmanager to private registry");
