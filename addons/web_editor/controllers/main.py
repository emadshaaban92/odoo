...
def prevent_diverging_history(record, html_field_name, incoming_history_ids):
...
def prevent_diverging_history_on_write(record, html_field_name, vals):
    if html_field_name in vals and record[html_field_name]:
        ...
        prevent_diverging_history(record, html_field_name, incoming_history_ids)
...
class Web_Editor(http.Controller):
    ...
    def ensure_common_history(self, model_name, field_name, res_id, history_ids):
        ...
        try:
            prevent_diverging_history(record, field_name, history_ids)
