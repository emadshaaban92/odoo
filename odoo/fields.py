...
class Properties(Field):
    ...
    def convert_to_read_multi(self, values, records, use_name_get=True):
        ...
        existing_ids_per_model = self._get_existences(records, values, use_name_get)

        # value is in record format
        for value in values:
            self._parse_json_types(value, records.env, existing_ids_per_model)
    ...
    def _get_existences(self, records, values_list, use_name_get=True):
    ...
    @classmethod
    def _parse_json_types(cls, values_list, env, existing_ids_per_model):
        ...
        for property_definition in values_list:
            ...
            if property_type == 'boolean':
                ...
                if property_value not in existing_ids_per_model[res_model]:
                    property_value = False
                ...
                property_value = [
                    ...
                    if id_ in existing_ids_per_model[res_model]
                ]
