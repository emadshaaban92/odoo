...
class test_res_lang(TransactionCase):
    ...
    @classmethod
    def setUpClass(cls):
        super(test_res_lang, cls).setUpClass()
    ...
    def test_res_lang_decimal_point_preview(self):
        self.assertEqual(self.lang_0.decimal_point_preview, '99.00')
        self.lang_0.write({'decimal_point': ','})
        self.assertEqual(self.lang_0.decimal_point_preview, '99,00')

    def test_res_lang_thousand_sep_preview(self):
        self.assertEqual(self.lang_0.thousand_sep_preview, '999,999,999')
        self.lang_0.write({'thousands_sep': '.'})
        self.assertEqual(self.lang_0.thousand_sep_preview, '999.999.999')
    ...
    def test_res_lang_date_format_preview(self):
        ...
        self.assertEqual(lang_0.date_format_preview, '01/01/2020')
        self.assertEqual(lang_1.date_format_preview, '01 يناير, 2020')

        (lang_0 | lang_1).write({'date_format': '%A-%B-%Y'})

        self.assertEqual(lang_0.date_format_preview, 'Wednesday-January-2020')
        self.assertEqual(lang_1.date_format_preview, 'الأربعاء-يناير-2020')
    ...
    def test_res_lang_time_format_preview(self):
        ...
        self.assertEqual(lang_0.time_format_preview, '16:00:00')
        self.assertEqual(lang_1.time_format_preview, '04:00:00')

        (lang_0 | lang_1).write({'time_format': '%M-%I-%S'})

        self.assertEqual(lang_0.time_format_preview, '00-04-00')
        self.assertEqual(lang_1.time_format_preview, '00-04-00')
