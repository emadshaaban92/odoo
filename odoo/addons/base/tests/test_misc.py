...
class TestFormatLangDate(TransactionCase):
    ...
    def test_01_code_and_format(self):
        ...
        # Depending of the version of babel, this may return "31 janv. 2017 à 11:33:00" or "31 janv. 2017, 11:33:00" (since Python 3.11 with debian Bookworm) and same for chinese
