...
class Lang(models.Model):
    ...
    date_format_preview = fields.Char(string='Date format preview', compute="_compute_date_format_preview", readonly=True, store=False)
    time_format = fields.Char(string='Time Format', required=True, default=DEFAULT_TIME_FORMAT)
    time_format_preview = fields.Char(string='Time format preview', compute="_compute_time_format_preview", readonly=True, store=False)
    ...
    def _compute_date_format_preview(self):
        ...
        for lang in self.filtered(lambda lang: lang.date_format and lang.code):
            ...
            lang.date_format_preview = babel.dates.format_datetime(fields.Datetime.now(), date_format, locale=locale)
    ...
    def _compute_thousand_separator_preview(self):
        ...
        for lang in self.filtered(lambda lang: lang.grouping and lang.thousands_sep):
            lang.thousand_sep_preview = intersperse('999999999', ast.literal_eval(lang.grouping), lang.thousands_sep)[0]
    ...
    def _compute_time_format_preview(self):
        ...
        for lang in self.filtered(lambda lang: lang.time_format and lang.code):
            ...
            lang.time_format_preview = babel.dates.format_time(fields.Datetime.now(), time_format, locale=locale)
