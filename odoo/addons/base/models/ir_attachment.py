...
class IrAttachment(models.Model):
    ...
    def _search(self, domain, offset=0, limit=None, order=None, access_rights_uid=None):
        ...
        ids = super(IrAttachment, self)._search(domain, offset=offset, limit=limit, order=order,
        ...
        if len(orig_ids) == limit and len(result) < self._context.get('need', limit):
            ...
            result.extend(self.with_context(need=need)._search(domain, offset=offset + len(orig_ids),
