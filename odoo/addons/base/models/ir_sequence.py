...
class IrSequence(models.Model):
    ...
    @api.depends('prefix', 'suffix', 'use_date_range', 'date_range_ids', 'date_range_ids.date_from', 'date_range_ids.date_to', 'date_range_ids.number_next_actual', 'number_next_actual')
