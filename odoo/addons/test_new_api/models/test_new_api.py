...
class Related(models.Model):
    ...
    related_invertible = fields.Char(string='Related invertible', related='name', inverse=True)
    ...
    related_store_invertible = fields.Char(string='Related store invertible', related='name', store=True, inverse=True)
